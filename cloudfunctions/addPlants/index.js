...
exports.main = async (event, context) => {
  const plants = [
    ...
    {name:"油画婚礼吊兰",scientificName:"Tradescantia zebrina",family:"鸭跖草科 Commelinaceae",origin:"墨西哥、中美洲",growthSeason:"春夏季生长快",heatResist:"35°C以下",coldResist:"不低于5°C",soil:"疏松排水好的营养土",location:"客厅、书房",waterFrequency:"4-5天/次（见干见湿）",light:"散射光",temperature:"15-28°C",fertilizer:"生长期每月一次",humidity:"中等湿度",toxicityLevel:"无刺激",toxicitySource:"可食用，无明显毒性",waterInterval:5},
